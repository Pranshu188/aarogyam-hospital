...
import { Calendar, Search, HeartPulse, Clock, Sparkles, ArrowRight } from 'lucide-react';
...
export const Hero: React.FC = () => {
  ...
  return (
    <section className="relative bg-gradient-to-b from-slate-50 via-white to-slate-50 pt-8 pb-16 lg:pt-12 lg:pb-20 overflow-hidden border-b border-slate-100">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center">
          {/* Left Column: Headlines, CTAs & Integrated Quick Search */}
          <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3 pt-1">
              <button
                ...
                className="w-full sm:w-auto px-6 py-3.5 rounded-xl bg-navy-900 hover:bg-navy-800 text-white font-semibold text-xs sm:text-sm shadow-md hover:shadow-xl transition-all transform hover:-translate-y-0.5 flex items-center justify-center gap-2"
              >
              ...
              <button
                ...
                className="w-full sm:w-auto px-6 py-3.5 rounded-xl bg-white hover:bg-slate-50 text-navy-950 font-semibold text-xs sm:text-sm border border-slate-300 hover:border-slate-400 transition-all shadow-sm flex items-center justify-center gap-2"
              >
            ...
            {/* Cleanly Integrated Quick Department Search */}
            <div className="pt-2 max-w-lg mx-auto lg:mx-0">
              <form
                onSubmit={handleQuickSearch}
                className="flex items-center gap-2 p-1.5 rounded-2xl bg-white border border-slate-200/90 shadow-soft focus-within:border-teal-500 focus-within:ring-1 focus-within:ring-teal-500 transition-all"
              >
                <div className="flex items-center gap-2 pl-3 flex-1 min-w-0">
                  ...
                  <select
                    ...
                    className="w-full text-xs font-medium text-slate-700 bg-transparent focus:outline-none cursor-pointer py-1.5 truncate"
                  >
                    <option value="">Instant Department Jump (Select Specialty)...</option>
                ...
                <button
                  type="submit"
                  className="px-4 py-2 rounded-xl bg-navy-900 hover:bg-navy-800 text-white text-xs font-bold transition-colors flex items-center gap-1 shrink-0"
                >
                  <span>Explore</span>
          ...
          <div className="lg:col-span-5 relative">
            <div className="relative mx-auto max-w-md lg:max-w-none">
              {/* Main Visual Image without any awkward overlapping search box */}
              <div className="rounded-3xl overflow-hidden shadow-2xl border-4 border-white bg-slate-100 relative aspect-[4/4.8]">
                <img
                  ...
                  alt="Senior Specialist Doctor at Aarogyam Hospital Ahmedabad"
              ...
              {/* Floating 24/7 Tag */}
              <div className="hidden sm:flex absolute -bottom-3 -right-3 bg-red-600 text-white px-3.5 py-2 rounded-2xl shadow-lg items-center gap-2 text-xs font-bold">
